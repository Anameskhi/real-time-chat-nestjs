...
export class UserController {
    ...
    create(@Body() createUserDto: CreateUserDto):Observable<IUser>{
        return this.userHelperService.CreateUserDtoTpEntity(createUserDto).pipe(
    ...
    findAll( 
        ...
        @Query('limit') limit: number = 10
            ...
            return this.userService.getAllUsers({page, limit, route: 'http://localhost:3000/api/users'})
